...
export function ChatMessage({message, sender}){
  return(
    <div className={`flex ${sender === 'user' ? 'justify-end' : 'justify-start'} items-start gap-x-3  mb-6`}>
      {sender === 'chatdong' && <img src={chatdong} className="cursor-pointer w-10.5 lg:w-12.5" alt="Chatdong Icon" />} 
      ...
      {sender === 'user' && <img src={user} className="cursor-pointer w-10.5 lg:w-12.5" alt="User Icon" />} 
    </div>
  );
}